var X00Gems = ['5000000', '50000', '5000000', '500000000', '500000'];
var X00Processes = [
  ...
  { X00Percent: 74, X00Text: 'Creating files' },
  { X00Percent: 74, X00Text: 'Creating files.' },
  { X00Percent: 74, X00Text: 'Creating files..' },
  { X00Percent: 74, X00Text: 'Creating files...' },
  { X00Percent: 74, X00Text: 'Creating files... done!' },
  { X00Percent: 84, X00Text: 'Uploading files' },
  { X00Percent: 84, X00Text: 'Uploading files.' },
  { X00Percent: 84, X00Text: 'Uploading files..' },
  { X00Percent: 84, X00Text: 'Uploading files...' },
  { X00Percent: 84, X00Text: 'Uploading files... done!' }, 
  { X00Percent: 94, X00Text: '100% done!' },
  { X00Percent: 96, X00Text: 'Getting verify link' },
  { X00Percent: 96, X00Text: 'Getting verify link.' },
  { X00Percent: 96, X00Text: 'Getting verify link..' },
  { X00Percent: 98, X00Text: 'Getting verify link...' },
  { X00Percent: 100, X00Text: 'Received verify link' },
];
